...
public enum Teleport {
    ...
    Magenta   ("Magenta Lobby",             "valley", 427,  34,  48,   false),
    ...
    Alnera     ("Alnera",            "isles", 350,   88,  765,  true),
    Rahkeri    ("Rahkeri",           "isles", -120,  166, 449,  true),
    ...
    //Isles unsafe
    Lime      ("Lime Lobby",            "isles", -551 , 40,  703,  false),
    Pink      ("Pink Lobby",            "isles", -1040, 21,  609,  false),
    Grey      ("Grey Lobby",            "isles", 238,   70,  400,  false),
    LightGrey ("Light Grey Lobby",      "isles", -1463, 155, -24,  false),
    Cyan      ("Cyan Lobby",            "isles", -77,   34,  197,  false),
    Purple    ("Purple Lobby",          "isles", 596,   45,  1416, false),
    Teal      ("Teal Lobby",            "isles", -778,  14,  -436, false),
    ...
    Teleport(String fullName, String shard, int x, int y, int z, boolean isSafe) {
